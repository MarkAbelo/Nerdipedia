...
const validationFunctions= {
    ...
    async validEmail(email){
        email = this.validString(email, 'Email');
    ...
    async validPassword(password) {
        ...
        password = this.validString(password, 'Password');
    ...
    async validSection(section) {
        ...
        section = this.validString(section, 'Section');
    ...
    async validPostBody(body){
        body = this.validString(body, 'Post body');
